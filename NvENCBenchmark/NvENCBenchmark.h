...
protected:
    ...
    NVENCSTATUS                                          loadframeFromImage(HANDLE hInputFile, uint32_t width, uint32_t height, NV_ENC_BUFFER_FORMAT inputFormat, int index);
    ...
    void                                                 LoadRGBBuffer(unsigned char *rgb, int width, int height, int index);
    void                                                 LoadNV12Buffer(unsigned char *yuv_luma, unsigned char *yuv_cb, unsigned char *yuv_cr, int width, int height, int index);
    void                                                 LoadYUV444Buffer(unsigned char *yuv_luma, unsigned char *yuv_cb, unsigned char *yuv_cr, int width, int height, int index);
    void                                                 LoadP010PLBuffer(unsigned short *yuv_luma, unsigned short *yuv_cb, unsigned short *yuv_cr, int width, int height, int index);
    void                                                 LoadYUV444Buffer(unsigned short *yuv_luma, unsigned short *yuv_cb, unsigned short *yuv_cr, int width, int height, int index);
};
